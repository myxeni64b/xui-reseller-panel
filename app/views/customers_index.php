...
<div class="card">
  ...
  <div class="actions" style="margin-bottom:14px;">
    ...
    <a class="btn <?php echo $bucket === 'ended' ? 'btn-primary' : ''; ?>" href="<?php echo panel_e($app->url('/' . $scope . '/customers') . '?' . $queryStringBase . '&bucket=ended'); ?>">Depleted / Ended <span class="badge bad" style="margin-left:8px;"><?php echo (int) panel_array_get($stateCounts, 'ended', 0); ?></span></a>
  </div>
  ...
  <table class="table">
    ...
    ?>
      <tr>
        ...
        <td><span class="badge <?php echo panel_e($runtimeStatusClass); ?>"><?php echo panel_e($runtimeStatusLabel); ?></span></td>
        <td>
