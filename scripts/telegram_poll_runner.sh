...
# Usage:
#   POLL_URL="https://example.com/panel/telegram/poll/SECRET?timeout=55" ./telegram_poll_runner.sh
# or:
#   ./telegram_poll_runner.sh "https://example.com/panel/telegram/poll/SECRET?timeout=55"
